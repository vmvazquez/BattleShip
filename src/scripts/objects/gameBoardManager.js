...
class createGameBoardManager {
  constructor() {
    ...
    this.directionMap.set(0, 'north');
    this.directionMap.set(1, 'east');
    this.directionMap.set(2, 'south');
    this.directionMap.set(3, 'west');
    this.cpuObjectMap = new Map();
    this.CPUShipLocationsToObjectMap();
  }
...
let gameBoardManager = new createGameBoardManager();
